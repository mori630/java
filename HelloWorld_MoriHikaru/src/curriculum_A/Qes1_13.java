...
public class Qes1_13 {
	...
	public static void main(String[] args) {
		...
		**********************************************************************************/
		...
		System.out.println(c + S + B); //a ハロー trueを表示
		...
		**********************************************************************************/
		...
		double HEIGHT = height8 / 100; //cm→mに変更
		...
		〜〜〜ここまで完了で「1.6 変数②」にチェック〜〜〜						
		**********************************************************************************/
		age8 = 24; //Q9で数値が変わってるので再代入
		System.out.println(age8 >= 25); //24歳なのでfalse

		/**********************************************************************************
		8で使用した【年齢・身長・体重】を文字列型に型変換し繋げて出力してください
		**********************************************************************************/
		height8 = 168.5; //Q9で数値が変わってるので再代入
		weight8 = 64.2; //Q9で数値が変わってるので再代入
		//int型をString型に変換
